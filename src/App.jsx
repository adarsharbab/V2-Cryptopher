...
export function Hero({ showVideo, setShowVideo }) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto mt-12 flex flex-col items-center space-y-8">
        <div className="flex flex-col items-center">
          
          <h1 className="mt-12 text-3xl font-bold text-white text-shadow-lg">
          Welcome to a new era of <br/> Crypto/Comics/Virtual Reality
          </h1>
          
        </div>
        <div className="space-y-4 text-center max-w-2xl">
          <p className="text-sm sm:text-base text-white">
          The Reeves Genesis Edition NFT is the first of its kind — an ultra-rare digital relic from the CryptoMan universe, forged at the dawn of a new era. More than a collectible — it’s a symbol of rebellion, power, and the rise of a decentralized legend.
          </p>
        </div>
           <div className="grid grid-cols-2 md:grid-cols-3 row-video gap-4 mb-8">
            {[
              "Artwork_2_Animation 2.mp4",
              "Artwork_2_Animation_PurpleEyes.mp4",
              "Artwork_2_Animation_RedEyes.mp4",
        ...
        <Button
          ...
          onClick={() => {
            ...
            window.open("https://magiceden.us/collections/base/0x2c2ae92a7c2a7a5ddf58e77f290bcbedc8336236", "_blank", "noopener,noreferrer");
          }}
        ...
        <Button
          className="mt-8 ml-4 bg-[#0052FF] text-white hover:bg-[#0052FF]/90"
          onClick={() =>
            document
    ...
    <GlowingBorder>
      <section className="py-20 px-4 ">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
          <GlowWrapper
            rounded
            className={"w-full  bg-black rounded-lg flex"}
          >
            <video
...
const Footer = () => {
  ...
  {[
    ...
    { 
      ...
      href: "https://www.youtube.com/@Metaguardianz"
    },
  ].map((platform) => (
    <Button
      key={platform.name}
